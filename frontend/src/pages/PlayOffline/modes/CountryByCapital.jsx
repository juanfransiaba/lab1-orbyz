...
function getPromptIdentity(country) {
    return normalizeKey(country?.capital);
}
...
function CountryByCapital() {
    ...
    // Guarda (solo metadata) la pregunta actual con sus opciones, para retomar exacto
    ...
    useEffect(() => {
        ...
        const init = async () => {
            ...
            try {
                ...
                const ongoing = await findOngoingMatch("country-by-capital");
                if (ongoing) {
